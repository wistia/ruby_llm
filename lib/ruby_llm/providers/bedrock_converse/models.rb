...
module RubyLLM
  module Providers
    class BedrockConverse
      ...
      module Models
        def list_models
          # BedrockConverse uses the same foundation models as Bedrock.
          # Return empty array to avoid duplicate API calls - models are already
          # fetched by the Bedrock provider. BedrockConverse handles arbitrary
          # model IDs gracefully via Model::Info.default in Models.resolve.
          []
        end
