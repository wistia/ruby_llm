  ...
  module Providers
    ...
    class Bedrock < Provider
      ...
      def ensure_configured!
        # Region is always required
        raise ConfigurationError, 'Missing configuration for Bedrock: bedrock_region' unless @config.bedrock_region
        ...
        raise ConfigurationError,
              'Missing configuration for Bedrock: either bedrock_bearer_token OR ' \
