...
RSpec.describe RubyLLM::Providers::Bedrock do
  ...
  describe '#parse_error' do
    context 'with empty response body' do
      it 'returns nil' do
        ...
        result = bedrock_instance.parse_error(response)
  ...
  describe '#build_request' do
    ...
    context 'with POST method' do
      it 'builds request with default POST method' do
        ...
        request = bedrock_instance.build_request(url, payload: payload)
      ...
      it 'explicitly sets POST method when specified' do
        ...
        request = bedrock_instance.build_request(url, method: :post, payload: payload)
    ...
    context 'with GET method' do
      it 'builds request with GET method' do
        request = bedrock_instance.build_request(url, method: :get)
      ...
      it 'omits body for GET requests' do
        request = bedrock_instance.build_request(url, method: :get, payload: nil)
    ...
    context 'with PUT method' do
      it 'builds request with PUT method' do
        ...
        request = bedrock_instance.build_request(url, method: :put, payload: payload)
    ...
    context 'with DELETE method' do
      it 'builds request with DELETE method' do
        request = bedrock_instance.build_request(url, method: :delete)
    ...
    context 'with different payloads' do
      it 'handles nil payload' do
        request = bedrock_instance.build_request(url, payload: nil)
    ...
    context 'with URL handling' do
      it 'uses provided URL' do
        ...
        request = bedrock_instance.build_request(custom_url, payload: {})

        expect(request[:url]).to eq(custom_url)
      end

      it 'falls back to completion_url when URL is nil' do
        allow(bedrock_instance).to receive(:completion_url).and_return('https://fallback.url')

        request = bedrock_instance.build_request(nil, payload: {})
  ...
  describe '#build_headers' do
    ...
    context 'with non-streaming request' do
      it 'builds headers with JSON accept type' do
        headers = bedrock_instance.build_headers(signature_headers, streaming: false)
    ...
    context 'with streaming request' do
      it 'builds headers with eventstream accept type' do
        headers = bedrock_instance.build_headers(signature_headers, streaming: true)
    ...
    context 'with empty signature headers' do
      it 'still includes Content-Type and Accept' do
        headers = bedrock_instance.build_headers({}, streaming: false)
    ...
    context 'with additional signature headers' do
      it 'preserves custom headers from signature' do
        ...
        headers = bedrock_instance.build_headers(custom_signature_headers, streaming: false)
    ...
    context 'header precedence' do
      it 'does not override Content-Type from signature headers' do
        ...
        headers = bedrock_instance.build_headers(headers_with_content_type, streaming: false)
      ...
      it 'does not override Accept from signature headers' do
        ...
        headers = bedrock_instance.build_headers(headers_with_accept, streaming: false)
    ...
    it 'always sets Content-Type to application/json' do
      headers_streaming = bedrock_instance.build_headers(signature_headers, streaming: true)
      headers_non_streaming = bedrock_instance.build_headers(signature_headers, streaming: false)
  ...
  describe '.capabilities' do
    it 'returns Bedrock::Capabilities' do
      expect(described_class.capabilities).to eq(RubyLLM::Providers::Bedrock::Capabilities)
    end
  end
