...
RSpec.describe RubyLLM::Providers::BedrockConverse::Signing do
  ...
  describe RubyLLM::Providers::BedrockConverse::Signing::Credentials do
  ...
  describe RubyLLM::Providers::BedrockConverse::Signing::Signer do
    let(:signer) do
      described_class.new(
        access_key_id: access_key_id,
        secret_access_key: secret_access_key,
    ...
    describe '#initialize' do
      it 'accepts required credentials and configuration' do
        ...
        expect(signer.credentials_provider).to be_a(
          RubyLLM::Providers::BedrockConverse::Signing::StaticCredentialsProvider
        )
      end
      ...
      it 'raises error when region is missing' do
        ...
        end.to raise_error(RubyLLM::Providers::BedrockConverse::Signing::Errors::MissingRegionError)
      end
      ...
      it 'raises error when credentials are missing' do
        ...
        end.to raise_error(RubyLLM::Providers::BedrockConverse::Signing::Errors::MissingCredentialsError)
      end
    ...
    describe '#sign_request' do
      ...
      it 'returns a Signature object' do
        ...
        expect(signature).to be_a(RubyLLM::Providers::BedrockConverse::Signing::Signature)
      end
  ...
  describe RubyLLM::Providers::BedrockConverse::Signing::UriUtils do
  ...
  describe RubyLLM::Providers::BedrockConverse::Signing::CryptoUtils do
  ...
  describe RubyLLM::Providers::BedrockConverse::Signing::CanonicalRequest do
    let(:config) { RubyLLM::Providers::BedrockConverse::Signing::CanonicalRequestConfig.new }
    ...
    describe '#signed_headers' do
      ...
      it 'excludes unsigned headers' do
        config_with_unsigned = RubyLLM::Providers::BedrockConverse::Signing::CanonicalRequestConfig.new(
  ...
  describe 'Integration: Full signing workflow' do
    it 'successfully signs a typical Bedrock request' do
      signer = RubyLLM::Providers::BedrockConverse::Signing::Signer.new(
        access_key_id: access_key_id,
        secret_access_key: secret_access_key,
        region: 'us-east-1',
        service: 'bedrock'
